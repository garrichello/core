...
class DataNetcdf(Data):
    ...
    def write_array(self, all_values, all_options):
        ...
        if new_file:
            ...
            lon = root.createDimension('lon', n_lon)  # pylint: disable=W0612
            lat = root.createDimension('lat', n_lat)  # pylint: disable=W0612
            if all_options['longitudes'].ndim == 1 and all_options['latitudes'].ndim == 1:
                ...
                longitudes = root.createVariable('lon', 'f4', ('lat', 'lon'))
                latitudes = root.createVariable('lat', 'f4', ('lat', 'lon'))
            else:
