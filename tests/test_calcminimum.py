...
from core.mod.calc.calcminimum import cvcCalcMinimum
...
class TimeMinTest(unittest.TestCase):
    ...
    def test_can_instantiate_min_module(self):
        ...
        time_min_module = cvcCalcMinimum(data_helper)
        self.assertIsInstance(time_min_module, cvcCalcMinimum)
    ...
    def test_one_point_min_is_correct(self):
        ...
        self.assertTrue(kwargs['values'] == [[261.]])
